...
def main(cfg: Config) -> None:
    ...
    if cfg.show_robots:
        ...
        print(f"[dual_interx_mesh_renderer] robot overlay enabled | urdf={urdf_path} | dof={robot_dof}")
    ...
    def _apply_frame(idx: int) -> None:
        ...
        if cfg.show_robots and qpos_b is not None and robot_b is not None and robot_b_root is not None and robot_dof is not None:
            qb = qpos_b[i]
